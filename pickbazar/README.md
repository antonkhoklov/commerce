...
###If throws erroe like only 'absolute URLS are supported' then head to the below file and comment down the "openmodal()" module
pickbazar/packages/shop/src/layouts/header/header.tsx
