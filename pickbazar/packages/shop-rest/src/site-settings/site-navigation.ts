...
export const TERMS_AND_CONDITIONS_PAGE = '/terms';
export const PRIVACY_POLICY_PAGE = '/privacy';
export const ABOUT_US_PAGE = '/aboutus';
export const CONTACT_US_PAGE = '/contact';
export const REFUND_AND_RETURN_PAGE = '/refund';
export const SHIPPING_AND_DELIVERY_POLICY = '/shipping';
export const PRICING_POLICY = '/pricing';
export const PRODUCT_AND_SERVICES = '/services';
export const REGISTERED_BUSINESS_NAME = '/registered';
// Mobile Drawer Menus
